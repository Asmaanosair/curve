  ...
  <CRow>
    ...
    Create Commission Method
      ...
      <transition name="slide">
        <CCard>
          <CCardHeader>
            <span :style="(color = 'red')">commissions</span>
          </CCardHeader>
...
export default {
  ...
  methods: {
    ...
    editLink(id) {
      return `commission/${id.toString()}/edit`;
    },
    fleetLink(id) {
      return `commission/${id.toString()}/fleet`;
    },
    showLink(id) {
      return `commission/${id.toString()}/show`;
    },
    createFleet() {
    ...
    deleteCommission(id) {
      ...
      axios
        .post(
          "/api/commission/" + id + "?token=" + localStorage.getItem("api_token"),
          {
            _method: "DELETE"
          }
        )
