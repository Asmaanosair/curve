    ...
    >
      <CCard no-header>
        <CCardBody v-if="changePasswordShow == true">
          ...
          <CButton color="success" @click="store()">{{ $t("save") }}</CButton>

          <CButton color="info" @click="changePassword()">{{
            $t("change_password")
          }}</CButton>
        </CCardBody>
