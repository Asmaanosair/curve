                  ...
                  <td>
                    <CButtonGroup>
                      <CButton
                        ...
                        ><CIcon name="cil-list"></CIcon> Manager</CButton
                      >
                    </CButtonGroup>
                  </td>
                </template>

                <template #Branches="{item}" hidden>
                  <td>
                    <CButtonGroup>
                      <CButton
                        size="sm"
                        ...
                        ><CIcon name="cil-list"></CIcon>  Branches
                      </CButton>
                    </CButtonGroup>
                  </td>
                </template>
                  ...
                  <td>
                    <CButtonGroup>
                      <CButton
                        ...
                        color="primary"
                        @click="SFleet(item.id)"
                        ><CIcon name="cil-list"></CIcon> المسؤلين</CButton
                      >
                    </CButtonGroup>
                  </td>
                </template>
...
export default {
  ...
  methods: {
    ...
    editLink(id) {
      return `client/${id.toString()}/edit`;
    },
    fleetLink(id) {
      return `client/${id.toString()}/manager`;
    },
    clientLink(id) {
      return `client/${id.toString()}/branches`;
    },
    showLink(id) {
      return `client/${id.toString()}/show`;
    },
    createFleet() {
